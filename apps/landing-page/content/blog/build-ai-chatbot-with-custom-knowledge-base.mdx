...
description: "Learn how to build AI chatbot with custom knowledge base using Flowise and Typebot. Follow our no-code guide to automate support and streamline operations today."
postedAt: "2024-12-18"
...
An AI chatbot is a software application that uses artificial intelligence to simulate human-like conversations. Unlike traditional rule-based chatbots that follow rigid decision trees, modern AI chatbots leverage LLMs. This allows them to understand context, generate natural responses, and handle complex queries with flexibility. To ensure responses feel conversational rather than robotic, some teams also use an [AI humanizer](https://undetectable.ai/ai-humanizer) to fine-tune tone and phrasing before deploying chatbot outputs in customer-facing environments.
...
- [Frequently Asked Questions (FAQs)](./faq-chatbot.mdx)
...
- [HR policies and procedures](./chatbot-hr-use-cases.mdx)
- Technical documentation
...
→ Explore more about [chatbot use cases](./chatbot-use-cases.mdx) to understand broader applications.
...
<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/render-deployment-type.avif" alt="Render Deployment Type" width={320} height={349}  />


1. Paste the public Flowise repository URL ([https://github.com/FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise))

<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/configure-flowise-deployment-render.avif" alt="Configure Flowise Deployment on Render" width={1423} height={327}  />


1. Then, most of the settings will apply automatically
2. Add these environment variables:

<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/render-auth-environment-variables.avif" alt="Render Auth Environment Variables" width={1381} height={544}  />
...
<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/cronjob-create-cron.avif" alt="Cronjob Create Cron" width={1283} height={249}  />


1. Configure the job:
  - **Title**: "Keep Flowise Alive."
  - **URL**: Your Render.com Flowise URL. You can find it on the Render dashboard
    <Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/render-service-url.avif" alt="Render Service Url" width={630} height={198}  />

  - **Schedule**: Every 10 minutes.
2. Save the configuration.

<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/cronjob-configuration.avif" alt="Cronjob Configuration" width={1280} height={1055}  />
...
With this setup, you’ve established the foundation for your knowledge base chatbot. **This free-tier configuration is ideal for testing or small-scale deployments.** For larger-scale production environments, consider upgrading to paid tiers or exploring alternative, [affordable hosting options](https://cybernews.com/best-web-hosting/cheap-web-hosting/).
...
<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/example-notion-knowledge-base.avif" alt="Example Notion Knowledge Base" width={1156} height={559}  />
...
1. **Add the Notion Loader**:
  - Drag the **"Notion Database"** loader from the sidebar.
   <Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/select-notion-loader-flowise.avif" alt="Select Notion Loader Flowise" width={409} height={609}  />
...
1. **Configure Document Splitting**:
...
<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/notion-loader-with-markdown-splitter.avif" alt="Notion Loader With Markdown Splitter" width={1189} height={859}  />
...
<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/flowise-complete-flow.avif" alt="Flowise Complete Flow" width={1492} height={1238}  />
...
<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/upsert-knowledge-base-flowise.avif" alt="Upsert Knowledge Base Flowise" width={152} height={88}  />


1. Use the **"Predict"** tab to test the flow with sample questions.
2. Navigate to the **Code icon** to get your endpoint URL.

<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/get-endpoint-from-flowise.avif" alt="Get Endpoint From Flowise" width={459} height={232}  />


1. Set up authentication if needed (recommended for production environments).
...
- Configure the request like so:
  <Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/typebot-http-request-config.avif" alt="Typebot Http Request Config" width={800} height={1204}  />
...
<Image src="/blog-assets/build-ai-chatbot-with-custom-knowledge-base/typebot-flow-using-flowise.avif" alt="Typebot Flow Using Flowise" width={1300} height={741}  />
...
<Info>
Looking for inspiration on how to deploy your chatbot effectively? Check out these [chatbot marketing examples](./chatbot-marketing-examples.mdx) to see how businesses are using AI chatbots to engage customers and drive results.
</Info>
