...
postedAt: "2025-05-28"
cover: "/blog-assets/chatbot-for-real-estate-agents/cover.avif"
author: younes
---
...
Chatbots handle [appointment scheduling 24/7](./appointment-scheduling-chatbot.mdx), freeing agents to prioritize high-value tasks and close deals faster.
...
Just copy this ID and use it in your embed code, like **<Typebot id="[ID OF THE TYPEBOT]" />** , replacing the ID with your own. This lets you quickly preview and deploy your chatbot with minimal effort.
...
1. Below the message, **add two buttons from Button block**:
...
1. **Input type:** Time block
2. **Save response as variable:** `visit_time.`
3. Should be look like this:
...
1. It will automatically add the data to the sheet.
...
- [Automated lead capture](./automated-lead-qualification.mdx) and segmentation
...
Start building your first chatbot flow today with Typebot. Transform those [late-night property inquiries into qualified leads](./chatbot-for-lead-qualification-in-real-estate.mdx) while you sleep.
