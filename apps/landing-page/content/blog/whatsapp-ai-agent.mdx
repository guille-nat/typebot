...
To enhance your agent's knowledge, explore our guide on [building a RAG chatbot](./how-to-build-a-rag-chatbot.mdx).

### Example of a WhatsApp AI Agent

<Image src="/blog-assets/whatsapp-ai-agent/example-ai-agent-reservation.avif" alt="Example Ai Agent Reservation" width={1170} height={2532}  />
...
To begin, **visit [Typebot](https://typebot.io) and create an account.** Once logged in:
...
To deploy Flowise, [follow our Flowise installation guide](https://typebot.io/blog/build-ai-chatbot-with-custom-knowledge-base#deploying-flowise-on-rendercom) to set up Flowise on your local machine or a cloud platform like Render.com. Ensure you have the necessary API keys (e.g., OpenAI, Pinecone) and configure them in Flowise.
...
<Image src="/blog-assets/whatsapp-ai-agent/example-notion-knowledge-base.avif" alt="Example Notion Knowledge Base" width={1156} height={559}  />
...
<Image src="/blog-assets/whatsapp-ai-agent/notion-loader-with-markdown-splitter.avif" alt="Notion Loader With Markdown Splitter" width={1189} height={859}  />
...
<Image src="/blog-assets/whatsapp-ai-agent/typebot-flow-using-flowise.avif" alt="Typebot Flow Using Flowise" width={1300} height={741}  />
...
<Image src="/blog-assets/whatsapp-ai-agent/example-chatbot-local-attractions-agent.avif" alt="Example Chatbot Local Attractions Agent" width={2270} height={1601}  />
